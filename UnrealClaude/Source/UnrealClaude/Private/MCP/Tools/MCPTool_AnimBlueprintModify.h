...
public:
	virtual FMCPToolInfo GetInfo() const override
	{
		...
		Info.Description = TEXT(
			"Animation Blueprint modification. Ops: get_info/state_machine, create_state_machine, "
			"add/remove_state/transition, set_entry_state/duration/priority, add_condition_node (TimeRemaining/Greater/And/Or/GetVariable), "
			"connect_condition_nodes, set_state_animation, batch. Ex: add_transition with from_state='Idle', to_state='Walk', duration=0.2."
		);
		Info.Parameters = {
